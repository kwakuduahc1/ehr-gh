...
namespace ShimsServer.Controllers.Vitals
{
    ...
    {
        /// <summary>
        /// Get vitals for a specific patient. Default is last 20 checks
        /// </summary>
        /// 

        [HttpGet("{id:guid}/{num:int?}")]
        ...
        public async Task<ActionResult<IEnumerable<VitalsDTO>>> GetVitals(Guid id, int num = 20) =>
        Ok(await repository.Vitals(id, num, HttpContext.RequestAborted));
