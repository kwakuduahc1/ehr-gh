...
namespace ShimsServer.Models.OPD
{
    ...
    public record AddVitalsDto(
        ...
        [StringLength(200, ErrorMessage = "Complaints must be between 3 and 200 characters")] string Complaints,
        [StringLength(200, ErrorMessage = "Notes must be between 5 and 200 characters")] string? Notes);
}
