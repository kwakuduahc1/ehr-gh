...
public record SchemesDTO(Guid SchemesID, string SchemeName, string Coverage, decimal MaxPayable, decimal Recovery, short Priority);
...
public record AddSchemeDto(
    ...
    [Range(0, double.MaxValue)] decimal Recovery,[Range(1,5), Required] short Priority = 3);
