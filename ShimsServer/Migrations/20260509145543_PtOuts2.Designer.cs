...
namespace ShimsServer.Migrations
{
    ...
    [Migration("20260509145543_PtOuts2")]
    partial class PtOuts2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShimsServer.Models.Drugs.DrugsRequests", b =>
                {
                    ...
                    b.HasOne("ShimsServer.Models.Records.Patients", "Patients")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_drugsrequests_patients_patientsid");
            ...
            modelBuilder.Entity("ShimsServer.Models.Services.ServiceRequest", b =>
                {
                    b.HasOne("ShimsServer.Models.Records.Patients", "Patients")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_servicerequests_patients_patientsid");
