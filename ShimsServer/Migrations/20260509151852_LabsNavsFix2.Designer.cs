...
namespace ShimsServer.Migrations
{
    ...
    [Migration("20260509151852_LabsNavsFix2")]
    partial class LabsNavsFix2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShimsServer.Models.Drugs.DrugsRequests", b =>
                {
                    ...
                    b.Property<Guid?>("PatientAttendancesID1")
                        .HasColumnType("uuid")
                        .HasColumnName("patientattendancesid1");
                    ...
                    b.HasIndex("PatientAttendancesID1");
            ...
            modelBuilder.Entity("ShimsServer.Models.Drugs.DrugsRequests", b =>
                {
                    ...
                    b.HasOne("ShimsServer.Models.Records.PatientAttendance", "PatientAttendance")
                        .WithMany()
                        .HasForeignKey("PatientAttendancesID1")
                        .HasConstraintName("fk_drugsrequests_patientattendances_patientattendancesid1");
            ...
            modelBuilder.Entity("ShimsServer.Models.Services.ServiceRequest", b =>
                {
                    b.HasOne("ShimsServer.Models.Records.PatientAttendance", "PatientAttendance")
                        .WithMany()
                        .HasForeignKey("PatientAttendancesID1")
                        .HasConstraintName("fk_servicerequests_patientattendances_patientattendancesid1");
