...
namespace ShimsServer.Migrations
{
    ...
    [Migration("20260414122332_RenameLabsToInvestigations8")]
    partial class RenameLabsToInvestigations8
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShimsServer.Models.Schemes.SchemeInvestigations", b =>
                {
                    ...
                    b.Property<Guid>("SchemeInvestigationsGroupID")
                        .HasColumnType("uuid")
                        .HasColumnName("schemeinvestigationsgroupid");
                    ...
                    b.HasIndex("SchemeInvestigationsGroupID");
            ...
            modelBuilder.Entity("ShimsServer.Models.Schemes.SchemeInvestigations", b =>
                {
                    b.HasOne("ShimsServer.Models.Labs.Investigations", "Investigations")
                        .WithMany("SchemeLabs")
                        .HasForeignKey("SchemeInvestigationsGroupID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_schemeinvestigations_investigations_schemeinvestigationsgro~");
