...
namespace ShimsServer.Migrations
{
    ...
    [Migration("20260414123841_RenameLabsToInvestigations9")]
    partial class RenameLabsToInvestigations9
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShimsServer.Models.Schemes.SchemeInvestigations", b =>
                {
                    b.HasOne("ShimsServer.Models.Labs.Investigations", "Investigations")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_schemeinvestigations_investigations_schemeinvestigationsid");
