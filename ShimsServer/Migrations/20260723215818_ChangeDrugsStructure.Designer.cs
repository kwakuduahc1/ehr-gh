...
namespace ShimsServer.Migrations
{
    ...
    [Migration("20260723215818_ChangeDrugsStructure")]
    partial class ChangeDrugsStructure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShimsServer.Models.Drugs.DrugsRequestDetails", b =>
                {
                    b.Property<Guid>("DrugsRequestDetailsID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("drugsrequestdetailsid");
                    ...
                    b.HasKey("DrugsRequestDetailsID")
                        .HasName("pk_drugsrequestdetails");

                    b.HasIndex("DrugsRequestsID");

                    b.HasIndex("SchemeDrugsID");

                    b.ToTable("drugsrequestdetails", (string)null);
                });
            ...
            modelBuilder.Entity("ShimsServer.Models.Drugs.DrugsRequests", b =>
                {
                    ...
                    b.Property<string>("DispensingUser")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasColumnName("dispensinguser");
                    ...
                    b.Property<string>("PaymentReceipt")
                        ...
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("paymentreceipt");

                    b.Property<string>("PaymentUser")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasColumnName("paymentuser");
            ...
            modelBuilder.Entity("ShimsServer.Models.Drugs.DrugsRequestDetails", b =>
                {
                    b.HasOne("ShimsServer.Models.Drugs.DrugsRequests", "DrugsRequests")
                        .WithMany("DrugsRequestDetails")
                        .HasForeignKey("DrugsRequestsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_drugsrequestdetails_drugsrequests_drugsrequestsid");
                    ...
                    b.HasOne("ShimsServer.Models.Schemes.SchemeDrugs", "SchemeDrugs")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_drugsrequestdetails_schemedrugs_schemedrugsid");
            ...
            modelBuilder.Entity("ShimsServer.Models.Drugs.DrugsRequests", b =>
                {
                    ...
                    b.HasOne("ShimsServer.Models.Schemes.SchemeDrugs", null)
            ...
            modelBuilder.Entity("ShimsServer.Models.Drugs.DrugsRequests", b =>
                {
                    b.Navigation("DrugsRequestDetails");
                });
