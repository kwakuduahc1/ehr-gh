...
namespace ShimsServer.Migrations
{
    ...
    [Migration("20260414121636_RenameLabsToInvestigations5")]
    partial class RenameLabsToInvestigations5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShimsServer.Models.Labs.InvestigationsRequests", b =>
                {
                    ...
                    b.HasOne("ShimsServer.Models.Schemes.SchemeInvestigations", "SchemeLabs")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_investigationsrequests_schemelabs_schemelabsid");
