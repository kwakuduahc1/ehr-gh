...
{
    /// <inheritdoc />
    public partial class RmUserIndex : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_laboratories", x => x.labgroupsid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    labparametersid = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_labparameters_laboratories_labgroupsid1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_schemelabs_laboratories_labgroupsid",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dateset = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    username = table.Column<string>(type: "character varying(75)", maxLength: 75, nullable: false),
                    servicesid1 = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_schemeservices_services_servicesid1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    username = table.Column<string>(type: "character varying(75)", maxLength: 75, nullable: false),
                    labparametersid1 = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_labresults", x => x.labpaymentid);
                    table.ForeignKey(
                        name: "fk_labresults_labparameters_labparametersid1",
                        column: x => x.labparametersid1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_labresults_labparametersid1",
                table: "labresults",
                column: "labparametersid1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_schemeservices_servicesid1",
                table: "schemeservices",
                column: "servicesid1");
